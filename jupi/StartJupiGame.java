...
public class StartJupiGame extends JFrame implements ActionListener {
	...
	//ImageIcon homePageImage = new ImageIcon("CaromBilliardLogo.jpg");
    ...
    public StartJupiGame() {
        ...
        message = new JScrollPane(new JLabel((new ImageIcon("CaromBilliardLogo.jpg"))));
        message.setPreferredSize(new Dimension(400, 400));
       // message.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_NEVER);
       message.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
       // message.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        message.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        jmessage.setFont(font);
        jmessage.setBackground(Color.LIGHT_GRAY);
        ...
        if (e.getSource() == play_now) {
            ...
            jmessage.setText("\nUse the mouse to aim the cue stick.\n\n"
            				+"Once you have the desired direction, left-click and hold down\n\n"
             				+"to drag back the cue and generate power.\n\n"          				 
            				+"Release mouse when desired power has been reached.");
            jmessage.setEditable(false);
            message.setViewportView(jmessage);
            ...
            jmessage.setText("Team 3 Developers:\n\n\n\n"
            				+"Spyro Spears \t\t- Project Manager / UML / Programmer\n\n\n"
            				+"Mimmi Mammo \t - GUI / Presentations / Revised Documentation\n\n\n"
            				+"Benjamin Toofer\t- Programmer / Physics Simulation");            
            jmessage.setEditable(false);
            message.setViewportView(jmessage);
        }
    }
